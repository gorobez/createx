(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".like-event__slider ")) new core(".like-event__slider ", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            navigation: {
                prevEl: ".like-event__arrow--left",
                nextEl: ".like-event__arrow--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".like-singlepost__slider ")) new core(".like-singlepost__slider ", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            navigation: {
                prevEl: ".like-singlepost__arrow--left",
                nextEl: ".like-singlepost__arrow--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    da.init();
    const buttons = document.querySelectorAll(".categories-courses-online__item");
    const cards = document.getElementsByClassName("courses-online-page__item");
    document.addEventListener("click", (e => {
        if (e.target.closest(".categories-courses-online__item")) {
            const currentCategory = e.target.dataset.filter;
            script_filter(currentCategory, cards);
            buttons.forEach((button => {
                button.classList.remove("_item-active");
            }));
            e.target.classList.add("_item-active");
        }
    }));
    function filterCount() {
        const allCount = document.querySelectorAll(".courses-online-page__item").length;
        const marketingCount = document.querySelectorAll(".marketing").length;
        const managementCount = document.querySelectorAll(".management").length;
        const recrutingCount = document.querySelectorAll(".recruting").length;
        const designCount = document.querySelectorAll(".design").length;
        const developmentCount = document.querySelectorAll(".development").length;
        buttons.forEach((button => {
            ...
            if ("all" === category.toLowerCase()) addElement(allCount);
            if ("marketing" === category.toLowerCase()) addElement(marketingCount);
            if ("management" === category.toLowerCase()) addElement(managementCount);
            if ("recruting" === category.toLowerCase()) addElement(recrutingCount);
            if ("design" === category.toLowerCase()) addElement(designCount);
            if ("development" === category.toLowerCase()) addElement(developmentCount);
        }));
    }
    filterCount();
    function script_filter(category, items) {
    ...
    for (const card of cards) card.ontransitionend = function() {
        if (card.classList.contains("anime")) card.classList.add("hide");
    };
    document.addEventListener("DOMContentLoaded", (function() {
        const deadline = new Date(2023, 3, 31);
        let timerId = null;
